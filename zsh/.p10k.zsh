# Generated by Powerlevel10k configuration wizard on 2024-01-09 at 10:31 -03.
...
() {
  ...
  # AWS Vault custom settings
  awsvault_prompt() {
    if [ ! -z "${AWS_VAULT-}" ]; then
      echo -n " ${AWS_VAULT-} "
    fi
  }
  typeset -g POWERLEVEK9K_CUSTOM_AWSVAULT="awsvault_prompt"
  typeset -g POWERLEVEL9K_CUSTOM_AWSVAULT_FOREGROUND="black"
  typeset -g POWERLEVEL9K_CUSTOM_AWSVAULT_BACKGROUND="cyan"
